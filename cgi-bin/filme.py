...
filme = [
    ...
    {
        "title": "So My Grandma's a Lesbian",
    ...
    {
        "title": "Dieses bescheuerte Herz",
        "genre": ["drama"],
        "land": "de",
        "type": "film",
        "age": "teens",
        "filter": ["tens", "wahr", "trigger1"]
    },
    {
        "title": "Matilda",
        "genre": ["drama", "comedy"],
